...
def main():
    ...
    # 保存最好的参数
    #torch.save(best_model, f'./figdata/best_model_cnn_transformer_{round(best_accuracy, 8)}.pt')
...
# 保存到CSV文件
    results_df.to_csv('./figdata/FCT_training_validation_resultep.csv', index=False)
